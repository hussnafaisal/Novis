...
export default async function Home() {
  ...
  return <main>
    ...
    <section className="brand-section my" ><SectionHeading eyebrow="THE NOVIS HOUSE" title="A signature point of view" text="Luxury does not require visual noise. Our black-and-gold identity keeps the product at the center." /><div className="brand-grid"><div><span>01</span><h3>Precision</h3><p>Clear specifications and reliable movements.</p></div><div><span>02</span><h3>Presence</h3><p>Balanced cases, considered finishes and strong silhouettes.</p></div><div><span>03</span><h3>Service</h3><p>Responsive support from selection through delivery.</p></div></div></section>
